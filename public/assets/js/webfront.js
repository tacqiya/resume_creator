...
$.each(country_list, function() {
    $('.country').append('<option value="' + this + '">' + this + '</option>');
});
...
$.each(monthNames, function() {
    $('.month').append('<option value="' + this + '">' + this + '</option>');
});


// $("#add-exp").on("click", function() {
$(document).on('click', '#add-exp', function() {
    let blkCount = $('.first-blk').length;
    var mylayer = $('.experince-blk .first-blk-' + blkCount).clone();
    mylayer.appendTo($("#extra-exp"));
});